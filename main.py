...
def find_intersection(site, tags, hubs, body, article, art_link, result):
    ...
    :param result: переменная в которую функция добавляет дату/время написания статьи, заголовок статьи и ссылку на нее,
    если находит пересечение множеств для определения наличия искомых ключевых слов в тегах, "хабах", заголовке, теле
    статьи. Слова во всех множествах приводятся к нижнему регистру
